...
public class MyUserInfoTokenServices extends UserInfoTokenServices {
    ...
    private OAuth2Authentication extractAuthentication(Map<String, Object> map) {
        ...
        Map<String, Object> test = (Map<String, Object>)map.get("oauth2Request");
        Set<String> scope2 = new HashSet<String>((ArrayList<String>) test.get("scope"));

//        Set<String> scope = (HashMap<String, Map<String, ArrayList<String>>>)(map.get("oauth2Request").get("scope"));
//        Set<String> resourceIds = (Set<String>) ((HashMap<String, Map<String, ArrayList<String>>>) map.get("oauth2Request")).get("resourceIds");
        OAuth2Request request = new OAuth2Request(null, this.clientId, (Collection)null, true, scope2, (Set)null, (String)null, (Set)null, (Map)null);
